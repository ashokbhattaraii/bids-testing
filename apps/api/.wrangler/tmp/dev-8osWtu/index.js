...
// .wrangler/tmp/bundle-TWXAQq/strip-cf-connecting-ip-header.js
...
router.post("/google/token", zValidator("json", googleTokenSchema), async (c) => {
  ...
  if (!row) {
    ...
    const jwtPayload2 = {
      ...
      role: profile3.email.toLowerCase() === "bhattaraiashok101@gmail.com" ? "admin" : "volunteer"
...
// .wrangler/tmp/bundle-TWXAQq/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TWXAQq/middleware-loader.entry.ts
